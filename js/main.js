...
(function($) {
    ...
    * ------------------------------------------------------ */
    var ssBackToTop = function() {
        ...
        FirstLinkImage = $("#one"),
        SecondLinkImage = $("#two"),
        ThirdLinkImage = $("#three")

        // Show or hide the sticky footer button
        $(window).on('scroll', function () {
            if ($(window).scrollTop() >= pxShow) {
                goTopButton.fadeIn(fadeInTime);
                FirstLinkImage.slideDown(slideTime);
                SecondLinkImage.slideDown(slideTime);
                ThirdLinkImage.slideDown(slideTime);
                //ThirdLinkImage.animate({ left: '250px' });
            } else {
                goTopButton.fadeOut(fadeOutTime);
                FirstLinkImage.slideUp(slideTime);
                SecondLinkImage.slideUp(slideTime);
                ThirdLinkImage.slideUp(slideTime);
            }
        });
    };
